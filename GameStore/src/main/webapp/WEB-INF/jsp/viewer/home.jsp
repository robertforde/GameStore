...
<div id="banner">
	<video width="320" height="240" controls>
		<source src="<c:url value='/resources/video/Batman-Arkham-Knight.mp4' />" type="video/mp4">
 	</video> 
</div>
...
<div id="box1">
  ...
  <div id="boxcontaints">
  	PS4
    <c:forEach var="row" items="${ViewsPS4}" >
    		<div class="results2">
    ...
    XBOX ONE
    <c:forEach var="row" items="${ViewsXBOX_ONE}" >
    		<div class="results2">
    ...
    PS3
    <c:forEach var="row" items="${ViewsPS3}" >
    		<div class="results2">
    ...
    XBOX 360
    <c:forEach var="row" items="${ViewsXBOX_360}" >
    		<div class="results2">
    ...
    Nintendo 3DS
    <c:forEach var="row" items="${Views3DS}" >
    		<div class="results2">
    ...
    PC
    <c:forEach var="row" items="${ViewsPC}" >
    		<div class="results2">
