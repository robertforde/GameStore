...
<head>
	...
	<title>ALRO GAMES Approve Users</title>
...
<div id="main">
  ...
  <div id="container">
		...
		<c:forEach var="row" items="${listApproveUsers}" >
			<tr>
				...
				<td><a href="goUserApproval?userId=${row.id}"><img src="<c:url value='/resources/images/approve.jpg' />" /></a></td>
