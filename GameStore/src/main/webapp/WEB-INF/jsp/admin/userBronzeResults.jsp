...
<head>
	...
	<link href="<c:url value='/resources/css/bronze_styles.css' />" rel="stylesheet" />
	...
	<c:if test="${fn:length(listGames) gt 0}">
		...
		<c:forEach var="row" items="${listGames}" >
			<div class="results">
				...
				<!--  <div class="product_image"><img src="<c:url value='${row.smallCoverLoc}' />" width="108" height="135" border="0" /></div> -->
