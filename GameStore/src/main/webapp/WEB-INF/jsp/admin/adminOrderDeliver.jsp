...
<div id="main">
  <div class="title">Deliver Orders</div>
  ...
  <div id="container">
  	...
  	<table>
		...
		<c:forEach var="row" items="${listDeliverOrders}" >
			<tr>
				...
				<td><a href="goOrderDelivery?orderId=${row.id}"><img src="<c:url value='/resources/images/deliver.jpg' />" /></a></td>
